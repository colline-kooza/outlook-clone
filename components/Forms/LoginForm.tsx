        ...
        <Card className="w-full max-w-[400px] shadow-lg backdrop-blur-sm bg-white/95">
          <CardContent className="p-6 space-y-6">
            <div className="text-center space-y-2">
              <h1 className="text-xl font-semibold text-gray-900">Welcome to the new Outlook</h1>
              ...
              <p className="text-sm text-gray-800">
                Outlook supports Microsoft 356 , Gmail , Yahoo , iCloud , iMap , and POP ,{" "}
            ...
            <div className="flex justify-center space-x-4">
              <Button variant="outline" size="icon"   onClick={handleGoogleSignIn} 
 className="w-10 h-10">
                <img
